...
After testing gene functional annotation across eight species, the built-in Java implementation produced results identical to those generated by the original eggNOG-mapper. The test results can be downloaded from https://mega.nz/file/5jYAkCBB#ttMKZo2f0JMOz3tKKq4f2Kl2uRXMmTE-TaZ0BTG7oRM.
...
Using the BLASTP results between pineapple and Arabidopsis thaliana as test data, MCScanX (Pure Java) produced results identical to those generated by the original MCScanX. The test results can also be downloaded from https://mega.nz/file/5jYAkCBB#ttMKZo2f0JMOz3tKKq4f2Kl2uRXMmTE-TaZ0BTG7oRM.
